...
def on_open(ws):
    ...
    # post = ("230","合肥鑫吉瑞投资管理有限公司	","913401213254816745","wcy123456","2020-07-01","2020-07-11","5")
    # post = ("76","合肥清联广告有限公司	","91340100062474949N","wcy123456","2020-07-01","2020-07-11","5")
    ...
    # post = ("2832","安徽百口汇食品有限公司","91340100MA2NMY1Q3Q","wcy123456","2020-06-01","2020-06-06","7")
    ...
    # post = ("350","合肥鲜又惠农业科技有限公司","91340104MA2TPHQJ0H","wcy123456","2020-06-01","2020-06-06","9")
    # post = ("2832","安徽百口汇食品有限公司","91340100MA2NMY1Q3Q","wcy123456","2020-05-01","2020-06-06","9")
    ...
    # post = ("71","合肥崇武商贸有限公司","91340100322780708G","wcy123456","2020-06-01","2020-06-06","9")
    # post = ("1833","合肥景熙和自动化科技有限公司","91340111MA2N9PAD9H","wcy123456","2020-06-01","2020-06-06","9")
    # post = ("294","合肥优顺荣服饰有限公司 ","913401000570183912","wcy123456","2020-06-01","2020-06-06","9")
    # post = ("23","密码错误测试 ","91340100MA2NN81X5W","","2020-06-01","2020-06-06","9")
    # post = ("83","合肥鑫山会计服务有限公司 ","913401003551536121","","202001","202007","11")
    ...
    post = ("8188","安徽青鸾网络科技有限公司 ","91340111MA2U47LTX8","wcy123456","202001","202007","12")
